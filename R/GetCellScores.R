...
#' @param slot a character specifying the slot to draw counts from. This can be 'counts' for raw counts, 'data' for normalized counts, or 'scaled' for scaled counts (Seurat v3/v4). Default is NULL
#' @param layer a character specifying the layer to draw counts from (Seurat v5). Default is NULL.
...
#' @export
#'
GetCellScores <- function(seurat_obj, signatures, assay = 'RNA', slot = NULL, layer = NULL) {
